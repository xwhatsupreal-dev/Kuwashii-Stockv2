      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 md:top-0 md:left-auto md:bottom-0 md:right-0 md:w-[400px] md:rounded-none md:h-full max-h-[85dvh] md:max-h-full bg-[#fdfdfd] rounded-t-3xl z-[101] overflow-y-auto font-sans pb-6 md:pb-0 shadow-2xl"
          >
              ...
              {currentUser ? (
                <>
                  ...
                  <div className="grid grid-cols-4 gap-2 mb-4">
                    <button onClick={() => { setPage?.('SHOP'); onClose(); }} className="flex flex-col items-center justify-center p-3 border border-gray-200 rounded-2xl bg-white shadow-sm hover:bg-gray-50 active:scale-95 transition-all">
                      <Home className="w-6 h-6 text-[#0ea5e9] mb-2" strokeWidth={1.5} />
                      <span className="text-[11px] font-medium text-gray-800">หน้าหลัก</span>
                    </button>
                    <button onClick={() => { setPage?.('STATEMENT'); onClose(); }} className="flex flex-col items-center justify-center p-3 border border-gray-200 rounded-2xl bg-white shadow-sm hover:bg-gray-50 active:scale-95 transition-all">
                      <Wallet className="w-6 h-6 text-[#0ea5e9] mb-2" strokeWidth={1.5} />
                      <span className="text-[11px] font-medium text-gray-800">Statement</span>
                    </button>
                    <button onClick={() => { setPage?.('SHOP'); onClose(); }} className="flex flex-col items-center justify-center p-3 border border-gray-200 rounded-2xl bg-white shadow-sm hover:bg-gray-50 active:scale-95 transition-all">
