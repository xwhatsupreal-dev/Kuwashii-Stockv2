  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4 pb-1.5 sm:pb-2">
        ...
        {/* Item Image Box */}
        <div className="relative w-full aspect-square rounded-xl bg-zinc-900/60 border border-white/5 mb-3 flex flex-col items-center justify-center">
          <div className="w-10 h-10 rounded-full bg-zinc-900/80 flex items-center justify-center border border-white/5 mb-2">
            <Package className="w-5 h-5 text-zinc-700" />
          </div>
          <div className="h-2 w-20 bg-zinc-900 rounded-md" />

          {/* Price Tag Overlay Placeholder */}
          <div className="absolute bottom-2 right-2 bg-zinc-950/90 py-1 px-2.5 rounded-lg border border-white/5">
            <div className="h-3 w-12 bg-zinc-900 rounded" />
          </div>

          {/* Stock Availability Indicator Placeholder */}
          <div className="absolute top-2 left-2 bg-zinc-950/90 py-1 px-2 rounded-md border border-white/5 flex items-center gap-1.5">
        ...
        <div className="space-y-3.5 bg-zinc-900/20 p-2.5 rounded-xl border border-white/5 text-[10px] font-sans">
      ...
      <div className="p-3 sm:p-4 pt-0">
        <div className="mt-2.5 space-y-2">
          ...
          <div className="h-8 bg-zinc-900/80 rounded-xl w-full border border-white/5" />
          
          {/* AI discussion tag button placeholder */}
          <div className="h-7 bg-zinc-900/50 rounded-xl w-full border border-white/5" />
        </div>
