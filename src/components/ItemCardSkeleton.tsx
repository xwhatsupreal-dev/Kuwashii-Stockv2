    ...
    >
      ...
      <div className="p-3 sm:p-4 pb-1.5 sm:pb-2">
        <div className="flex items-center justify-between gap-1.5 mb-2.5">
          ...
          <div className="h-5 w-16 bg-zinc-900 rounded-md border border-zinc-800/40" />

          {/* Rarity Placeholder */}
          <div className="h-5 w-24 bg-zinc-900 rounded-md border border-zinc-800/40" />
        </div>
        ...
        <div className="relative w-full h-32 rounded-xl bg-zinc-900/60 border border-zinc-800/50 mb-3 flex flex-col items-center justify-center">
          ...
          <div className="absolute bottom-2 right-2 bg-zinc-950/90 py-1 px-2.5 rounded-lg border border-zinc-800/50">
            <div className="h-3 w-12 bg-zinc-900 rounded" />
          </div>

          {/* Stock Availability Indicator Placeholder */}
          <div className="absolute top-2 left-2 bg-zinc-950/90 py-1 px-2 rounded-md border border-zinc-800/40 flex items-center gap-1.5">
        ...
        <div className="h-5 w-2/3 bg-zinc-900/90 rounded-md mb-2.5" />

        {/* Description Placeholder */}
        <div className="space-y-1.5 mb-3.5">
          <div className="h-3 w-full bg-zinc-900/70 rounded" />
          <div className="h-3 w-5/6 bg-zinc-900/60 rounded" />
        </div>

        {/* Info Grid / Stock Meter Placeholder */}
        <div className="space-y-3.5 bg-zinc-900/20 p-2.5 rounded-xl border border-zinc-900/50 text-[10px] font-sans">
          <div className="flex items-center justify-between">
            <div className="h-2.5 w-16 bg-zinc-900/80 rounded" />
            <div className="h-3.5 w-14 bg-zinc-900 rounded" />
          </div>

          {/* Progress bar visual */}
          <div className="space-y-1.5 pt-0.5">
            <div className="w-full bg-zinc-950 h-1.5 rounded-full p-0.5 flex items-center border border-zinc-900/30">
              <div className="h-0.5 bg-zinc-900 rounded-full w-2/3" />
            </div>
            <div className="flex justify-between">
              <div className="h-2.5 w-16 bg-zinc-900/50 rounded" />
              <div className="h-2.5 w-6 bg-zinc-900/60 rounded" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 sm:p-4 pt-0">
        <div className="mt-2.5 space-y-2">
          ...
          <div className="h-8 bg-zinc-900/80 rounded-xl w-full border border-zinc-800/35" />
          
          {/* AI discussion tag button placeholder */}
          <div className="h-7 bg-zinc-900/50 rounded-xl w-full border border-zinc-900/40" />
        </div>
